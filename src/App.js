    ...
    <div className="container">
      ...
      <footer>
        <div className="footerContainer">
          <h2>Unlimited Acces To 100+ Instuctors.</h2>
          <ul className="footerNavBar">
            <li className="btn">All categories</li>
            <li className="btn">Entraitenemnt </li>
            <li className="btn">Lifestyle</li>
            <li className="btn">Writting</li>
            <li className="btn">Business</li>
            <li className="btn">Cooking</li>
            <li className="btn">Sucking</li>
